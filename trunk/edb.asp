...
Const Version = "1.6.1 (2009/04/20)"
...
Sub ScriptInit
  ...
  if InArray(Replace(FolderSpec, DefaultVPath, ""), arrPathsToExclude) Then FolderSpec = DefaultVPath
  '}
...
Function bShowFile(ByRef objFile)
  ...
  Dim vpath
  ppath = objFile.path
  vpath = Replace(ppath, DefaultPhysPath, "")
  vpath = replace(vpath, "\", "/")
